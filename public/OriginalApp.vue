          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <router-link 
                  v-for="item in navigation" :key="item.name" :to="item.to" active-class="bg-gray-900 text-white"
...
<script>
  ...
  const navigation = [
    { name: 'Acceuil', to: { name: 'Home' } },
    { name: 'Sondages', to: { name: 'Survey' } },
  ]
  ...
  export default {
    ...
    setup() {
      const store = useStore(); // call user data from store
